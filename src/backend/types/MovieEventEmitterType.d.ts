...
export type MovieOnEventPayload = Pick<
    MovieInfo,
    'name_cn' | 'name_en' | 'summary' | 'poster' | 'year' | 'backdrop' | 'casts' | 'crews' | 'duration' | 'genres' | 'release_date' | 'language' | 'spoken_language' | 'country' | 'original_title' | 'original_language' | 'imdb_id' | 'imdb_sid' | 'imdb_url' | 'imdb_rating' | 'imdb_votes'
