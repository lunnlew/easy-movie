<template>
  ...
  >
    <span style="color:#fff" v-if="showUpdateTip == 1">发现新的版本需要更新。</span>
    <div
    ...
    <span style="color:#fff" v-else-if="showUpdateTip == 4">已经是最新版本了。</span>
    <template #footer>
